...
mod tests {
    ...
    fn setup() -> VotingMachine {
        let candidates = vec![
            Candidate(String::from("Alfeus")),
            Candidate(String::from("Beltius")),
        ];
    ...
    fn test_accepted_vote() {
        ...
        let ballot_paper = BallotPaper {
            voter: Voter(String::from("Beltius")),
            candidate: Some(Candidate(String::from("Alfeus"))),
        };
